...
set j            / trad_cars, hybrid, plg_hybrid, edv, battery, pt, next_gen_battery /;
set jreal(j)     / trad_cars, hybrid, plg_hybrid, edv, battery, next_gen_battery /;
...
set jmcost_inv(jreal) / trad_cars, hybrid, plg_hybrid, edv, battery, next_gen_battery /;
...
* I_EN 'Investments in Energy sectors [T$]';
* K_EN'[million vehicles] for light duty vehicles'
