...
```{r}
path <- "C:/Users/modin/Desktop/Ettore/UNIVERSITA/ECC_GAMS/witchmodel"
...
res = res[which( res$n %in% c("usa","europe","china")),]
res
```
...
scale_x_continuous(limits=c(first_year+tstep, max_year),
                    breaks=seq(first_year+tstep, max_year,by = 5)) + 
