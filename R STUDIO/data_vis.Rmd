...
```{r}
res = res[which(res$V1 == "trad_cars" ),]
```

# chose subgroup not grouped by region
```{r}
chosen_countrys = c("usa","europe","china")
res = res[which(res$V1 == "trad_cars" & res$n %in% chosen_countrys),]
```
...
```{r}
res = res[which(res$V1 == "trad_cars" ),]
res = res[which(res$V2 == "trad_cars" ),]
```

# chose subgroup not grouped by region
```{r}
chosen_countrys = c("usa","europe","china")
res = res[which(res$V1 == "trad_cars" & res$V2 == "trad_cars" & res$n %in% chosen_countrys),]
