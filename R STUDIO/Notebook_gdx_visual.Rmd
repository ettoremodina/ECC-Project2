...
```{r}
myfiles = file.path('./',c("results_ssp2_bau.gdx","results_ssp2_ctax50.gdx"))
...
myfiles <- file.path("./", c("results_ssp2_bau.gdx","results_ssp2_ctax50.gdx","results_ssp2_ctax100.gdx"))
